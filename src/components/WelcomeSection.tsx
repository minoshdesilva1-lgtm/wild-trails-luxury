    ...
    <section id="welcome" className="section-padding bg-card relative overflow-hidden">
      ...
      >
        ...
        <div className="max-w-[750px] mx-auto">
          ...
          <img src={miliSignature} alt="Mili signature" width={72} height={48} decoding="async" className="h-12 mx-auto mb-2 opacity-70 hover:opacity-100 transition-opacity duration-500" />
