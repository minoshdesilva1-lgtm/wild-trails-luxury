...
const reviews = [
  ...
  },
  {
    ...
    date: 'August 2025',
    rating: 5,
    title: 'Nice stay in Yala national park',
    text: 'This was a beautiful stay with nice staff and good food. Of course we had a safari trip. The bush walk with the owner was very nice. The Tents are very nice and clean. It is nature so monkeys are all around. In the tent are nice beds, luxury facilities of bathroom, fan and wifi.',
  },
];
